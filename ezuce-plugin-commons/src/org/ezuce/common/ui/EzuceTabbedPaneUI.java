...
/**
 * Customize the look and feel of the main tab panel. This class isn't really
 * meant to be reusable, but it is too big to be an inner class.
 *
 * @author alex
 *
 */

public final class EzuceTabbedPaneUI extends BasicTabbedPaneUI
{
    ...
    private static final Color GRADIENT_TOP = new Color(250, 250, 250);
    private static final Color GRADIENT_BOTTOM = new Color(232, 233, 233);
