...
public class EzucePreferenceDialog extends PreferenceDialog {
	...
	public EzucePreferenceDialog() {
		...
		preferenceDialog.setTitle(Res.getString("title.preferences"));
	...
	public void invoke(JFrame parentFrame, PreferencesPanel contentPane) {
		PreferenceDataBuilder.buildPreferensCategories(
				contentPane.getPreferences().iterator(), prefCategories);
		preferencesList.setSelectedValue(contentPane.getSelectedPref());
		showDialog();
	};

	@Override
	public JDialog getDialog() {
		return new JDialog(preferenceDialog);
	}
	...
	private void initComponents() {
		// create
		btnApply = WidgetBuilder.createJButton(Res.getString("apply"));
		btnSave = WidgetBuilder.createJButton(Res.getString("save"));
		btnClose = WidgetBuilder.createJButton(Res.getString("close"));
	...
	private void updateContent(Preference pref) {
		...
		// init title
		titleLabel.setIcon(pref.getTitleIcon());
