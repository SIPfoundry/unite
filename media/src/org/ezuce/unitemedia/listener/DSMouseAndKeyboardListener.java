...
public class DSMouseAndKeyboardListener implements RemoteControlListener,
	...
	/**
	 * Creates a new listener of mouse and key event for a the video diplaying
	 * the streamed remote desktop. The video component is null until calling
	 * the setVideoComponent function.
	 * 
	 * @param remoteCallPeer
	 *            The remote controlled call peer to which the events must be
	 *            sent.
	 */
	public DSMouseAndKeyboardListener(CallPeer remoteCallPeer) {
		this.remoteCallPeer = remoteCallPeer;

		this.opSetDesktopSharingClient = remoteCallPeer.getProtocolProvider()
	...
	public void setVideoComponent(Component videoComponent) {
		synchronized (this.videoComponentMutex) {
			...
			if (this.videoComponent != null && videoComponent == null) {
			...
			else if (this.videoComponent == null && videoComponent != null) {
	 ...
	 * 
	 * @param event
	 *            The event which grants us the control of the remote call peer.
	 */
	...
	public void mouseDragged(MouseEvent e) {
		opSetDesktopSharingClient.sendMouseEvent(remoteCallPeer, e,
	...
	public void keyTyped(KeyEvent e) {
		opSetDesktopSharingClient.sendKeyboardEvent(remoteCallPeer, e);
	}
}
